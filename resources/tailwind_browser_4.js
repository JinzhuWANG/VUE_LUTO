                ...
                if (v === Pe) u === "" && (p = g), (u += t.slice(g, g + 2)), (g += 1);
                    ...
                    if (
                        ...
                        (m === Oe ||
                            m === ne ||
                            m === He ||
                            (m === Ye && (m = t.charCodeAt(g + 2)) && m == ne))
                    )
                        continue;
                    if (v === ne) {
                        if (u.length === 0) continue;
                        (m = u.charCodeAt(u.length - 1)),
                            m !== Oe && m !== ne && m !== He && (u += " ");
                        ...
                        o && (($.src = [o, x, g]), ($.dst = [o, x, g])),
                            a ? a.nodes.push($) : e.push($),
                            (u = "");
                    } else if (v === Ge && u.charCodeAt(0) === yt)
                        (f = _e(u)),
                            o && ((f.src = [o, p, g]), (f.dst = [o, p, g])),
        ...
        for (let i = r + 1; i < t.length; i++)
            if (((e = t.charCodeAt(i)), e === Pe)) i += 1;
                ...
                if (
                    e === Ge &&
                    (t.charCodeAt(i + 1) === ne ||
                        (t.charCodeAt(i + 1) === Ye && t.charCodeAt(i + 2) === ne))
                )
                    throw new Error(
                        `Unterminated string: ${t.slice(r, i + 1) + String.fromCharCode(o)}`
                    );
                if (e === ne || (e === Ye && t.charCodeAt(i + 1) === ne))
                    throw new Error(
                        `Unterminated string: ${t.slice(r, i) + String.fromCharCode(o)}`
                    );
            }
        return r;
    }
    ...
    var Je = class {
        ...
        add(r, o, e = 0, i) {
            ...
            o === "initial"
                ...
                : this.values.set(r, { value: o, options: e, src: i });
        }
        keysInNamespaces(r) {
            let o = [];
            for (let e of r) {
                ...
                for (let s of this.values.keys())
                    s.startsWith(i) &&
                        s.indexOf("--", 2) === -1 &&
                        (tr(s, e) || o.push(s.slice(i.length)));
            }
            return o;
        }
        get(r) {
            ...
            if (k.kind === "declaration") {
                ...
                if (o & 1) {
                    let V = k.params,
                        R = null,
                        K = !1;
                    for (let D of k.nodes)
                        D.kind === "declaration" &&
                            (D.property === "initial-value"
                                ? (R = D.value)
                                : D.property === "inherits" && (K = D.value === "true"));
                    let P = l(V, R ?? "initial");
            ...
            for (let [k, x] of a)
                for (let y of x) {
                    ...
                    let b = q(y.value),
                        V = !1;
                    if (
                        (ee(b, (P, { replaceWith: D }) => {
                            if (P.kind !== "function" || P.value !== "color-mix") return;
                            let _ = !1,
                                H = !1;
                            if (
                                (ee(P.nodes, (L, { replaceWith: B }) => {
                                    if (
                                        L.kind == "word" &&
                                    ...
                                    do {
                                        ...
                                        if (
                                            (n.add(h),
                                                (V = !0),
                                                (ie = r.theme.resolveValue(null, [d.value])),
                                                !ie)
                                        ) {
                                            _ = !0;
                                            return;
                                ...
                                let L = P.nodes.findIndex(
                                    (J) => J.kind === "separator" && J.value.trim().includes(",")
                                );
                                if (L === -1) return;
    ...
    function le(t, r) {
        ...
        function i(a, f = 0) {
            ...
            if (a.kind === "declaration") {
                if (
                    ((u += `${c}${a.property}: ${a.value}${a.important ? " !important" : ""
                        };
`),
                        r)
                ) {
...
`),
    ...
    function mr(t, r, o, e = new Set()) {
        ...
        {
            let s = o.get(t) ?? [];
            for (let a of s) if (mr(a, r, o, e)) return !0;
        }
        return !1;
    }
    function pr(t) {
        ...
        for (let [m, g] of p) {
            ...
            }
            {
                ...
                if (k !== -1) {
                    ...
                    let y =
                        f === null || v.modifier?.kind === "arbitrary" ? null : `${g}/${f}`;
            ...
            if (r.value.kind === "arbitrary") {
                if (r.value !== null) {
                    let i = Rt(r.value.value),
                        ...
                        [a, f] = i ? ["(", ")"] : ["[", "]"];
                    r.value.dataType
                        ? (e += `-${a}${r.value.dataType}:${$e(s)}${f}`)
                        : (e += `-${a}${$e(s)}${f}`);
                }
            } else r.value.kind === "named" && (e += `-${r.value.value}`);
        return (
            r.kind === "arbitrary" && (e += `[${r.property}:${$e(r.value)}]`),
                ...
                if (
                    ...
                    e.kind === "separator" && e.value.trim() === "/"
                        ...
                        : e.kind === "separator" &&
                            e.value.length > 0 &&
                            e.value.trim() === ""
                            ? (s[0] === e || s[s.length - 1] === e) && o.add(e)
                            : e.kind === "separator" &&
                            e.value.trim() === "," &&
                            (e.value = ",");
            }),
            o.size > 0 &&
            ee(r, (e, { replaceWith: i }) => {
    ...
    function Y(t, r) {
        ...
        for (let o of r) if (ii[o]?.(t)) return o;
        return null;
    }
    var ni = /^url\(.*\)$/;
    function Nr(t) {
    ...
    function li(t) {
        return U(t, " ").every(
            (r) => ot(r) || Sr(r) || r === "thin" || r === "medium" || r === "thick"
        );
    }
    ...
    function Pr(t) {
        ...
        e("isolate", [["isolation", "isolate"]]),
            ...
            i("z", {
                supportsNegative: !0,
                handleBareValue: ({ value: n }) => (T(n) ? n : null),
                themeKeys: ["--z-index"],
            ...
            return (d) => {
                ...
                return d.value.kind === "arbitrary"
                    ...
                    : ((h = t.resolve(d.value.value, ["--scale"])),
                        !h && T(d.value.value) && (h = `${d.value.value}%`),
                        h
                            ? ((h = n ? `calc(${h} * -1)` : h),
                                [
                                    c(),
        ...
        for (let n of ["x", "y", "z"])
            i(`scale-${n}`, {
                supportsNegative: !0,
                themeKeys: ["--scale"],
                handleBareValue: ({ value: d }) => (T(d) ? `${d}%` : null),
                handle: (d) => [
                    c(),
                    l(`--tw-scale-${n}`, d),
                    l(
            ...
            return (d) => {
                ...
                if (d.value.kind === "arbitrary") {
                    ...
                    ((h = t.resolve(d.value.value, ["--rotate"])),
                        !h && T(d.value.value) && (h = `${d.value.value}deg`),
                        !h)
                )
                    return;
        ...
        for (let [n, d] of [
            ...
            e(
                ...
                i(n, { themeKeys: ["--radius"], handle: (h) => d.map((A) => l(A, h)) });
        e("border-solid", [
            ...
            let h = function (C) {
                ...
                w = function ({ negative: C }) {
                    return (O) => {
                        ...
                        if (T(E))
                            return (
                                (E = C ? `calc(${E}deg * -1)` : `${E}deg`),
                                [
                                    l("--tw-gradient-position", `from ${E} ${S}`),
                                    l(
                                        "background-image",
                                        "conic-gradient(var(--tw-gradient-stops))"
                                    ),
            ...
            });
        {
            ...
            r.functional("filter", (w) => {
                ...
                i("brightness", {
                    ...
                    handleBareValue: ({ value: w }) => (T(w) ? `${w}%` : null),
                    handle: (w) => [
                        h(),
                ...
                i("hue-rotate", {
                    ...
                    handleBareValue: ({ value: w }) => (T(w) ? `${w}deg` : null),
                    handle: (w) => [
                        h(),
                    ...
                    if (
                        (w.modifier &&
                            (w.modifier.kind === "arbitrary"
                                ? (C = w.modifier.value)
                                : T(w.modifier.value) && (C = `${w.modifier.value}%`)),
                            !w.value)
                    ) {
                ...
                i("backdrop-opacity", {
                    ...
                    handleBareValue: ({ value: w }) => (it(w) ? `${w}%` : null),
                    handle: (w) => [
                        A(),
                        ...
                        if (
                            (A.value.kind === "arbitrary"
                                ...
                                : ((w = t.resolve(A.value.fraction ?? A.value.value, [
                                    ...
                                    w === null && T(A.value.value) && (w = `${A.value.value}ms`)),
                                w !== null)
                        )
            ...
            });
        {
            ...
            e("contain-none", [["contain", "none"]]),
                ...
                i("contain", { themeKeys: [], handle: (h) => [l("contain", h)] });
        }
        ...
        }
        {
            ...
            r.static("outline-hidden", () => [
                ...
                i("outline-offset", {
                    ...
                    handleBareValue: ({ value: d }) => (T(d) ? `${d}px` : null),
        ...
        i("opacity", {
            themeKeys: ["--opacity"],
            handleBareValue: ({ value: n }) => (it(n) ? `${n}%` : null),
            ...
            i("underline-offset", {
                ...
                handleBareValue: ({ value: n }) => (T(n) ? `${n}px` : null),
        ...
        e("text-shadow-initial", [D, ["--tw-text-shadow-color", "initial"]]),
            r.functional("text-shadow", (n) => {
                ...
                if (
                    (n.modifier &&
                        (n.modifier.kind === "arbitrary"
                            ? (d = n.modifier.value)
                            : T(n.modifier.value) && (d = `${n.modifier.value}%`)),
                        !n.value)
                ) {
                ...
                switch (n.value.value) {
                    ...
                    case "inherit":
                        return n.modifier
                            ? void 0
                            : [D(), l("--tw-text-shadow-color", "inherit")];
                }
                {
            ...
            ]);
        {
                    ...
                    if (
                        (S.modifier &&
                            (S.modifier.kind === "arbitrary"
                                ? (E = S.modifier.value)
                                : T(S.modifier.value) && (E = `${S.modifier.value}%`)),
                            !S.value)
                    ) {
                        let z = t.get(["--shadow"]);
                        return z === null
                            ...
                            case "color":
                                return (
                                    ...
                                    z === null
                                        ...
                                        : [
                                            h(),
                                            l("--tw-shadow-color", Q(z, "var(--tw-shadow-alpha)")),
                                        ]
                                );
                            default:
                                return [
                ...
                o("shadow", () => [
                    {
                        ...
                        modifiers: Array.from({ length: 21 }, (S, E) => `${E * 5}`),
                    },
                    { values: ["none"] },
                    {
                            ...
                            default:
                                return [
                                    ...
                                    ...pe(
                                        ...
                                        z,
                                        E,
                                        (wt) => `var(--tw-inset-shadow-color, ${wt})`,
                                        "inset "
                                    ),
                                    l("box-shadow", n),
                                ];
            ...
            r.functional("ring", (S) => {
                ...
                if (S.value.kind === "arbitrary") {
                    ...
                    switch (S.value.dataType ?? Y(E, ["color", "length"])) {
                        case "length":
                            return S.modifier
                                ? void 0
                                : [h(), l("--tw-ring-shadow", w(E)), l("box-shadow", n)];
                        default:
                            return (
                                (E = X(E, S.modifier, t)),
                                E === null ? void 0 : [l("--tw-ring-color", E)]
                            );
                    }
                }
                {
                ...
                }
                {
                    ...
                    if ((E === null && T(S.value.value) && (E = `${S.value.value}px`), E))
                        return [h(), l("--tw-ring-shadow", w(E)), l("box-shadow", n)];
                }
            }),
                o("ring", () => [
                ...
                r.functional("inset-ring", (S) => {
                        ...
                        switch (S.value.dataType ?? Y(E, ["color", "length"])) {
                            case "length":
                                return S.modifier
                                    ...
                                    : [
                                        h(),
                                        l("--tw-inset-ring-shadow", C(E)),
                                        l("box-shadow", n),
                                    ];
                            default:
                                return (
                                    (E = X(E, S.modifier, t)),
                                    E === null ? void 0 : [l("--tw-inset-ring-color", E)]
                                );
                        }
                    }
                    {
                    ...
                    }
                    {
                        ...
                        let E = t.resolve(S.value.value, ["--ring-width"]);
                        if (
                            (E === null && T(S.value.value) && (E = `${S.value.value}px`), E)
                        )
                            return [
                                h(),
                                l("--tw-inset-ring-shadow", C(E)),
                        ...
                        switch (S.value.dataType ?? Y(E, ["color", "length"])) {
                            case "length":
                                return S.modifier
                                    ? void 0
                                    : [
                                        l("--tw-ring-offset-width", E),
                                        l("--tw-ring-offset-shadow", O),
                                    ];
                            default:
                                return (
                                    (E = X(E, S.modifier, t)),
                                    E === null ? void 0 : [l("--tw-ring-offset-color", E)]
                                );
                        }
                    }
                    {
...
`);
                    ...
                    o.utilities.suggest(r.slice(0, -2), () => {
                        ...
                        for (let [
                            ...
                            for (let m of o.theme.keysInNamespaces(p))
                                a.push(m.replace(Rr, (g, v, k) => `${v}.${k}`));
                        }
        ...
        return s
            ? [
                l(
                    ...
                    i +
                    U(r, ",")
                        .map((f) => `drop-shadow(${ze(f, e)})`)
                        .join(" ")
                ),
                G("@supports (color: lab(from red l a b))", [l(t, i + a)]),
            ]
            : [l(t, i + a)];
    }
    ...
    function Ti(t, r, o, ...e) {
        ...
        if (!i || !s)
            throw new Error(
                `The --alpha(\u2026) function requires a color and an alpha value, e.g.: \`--alpha(${i || "var(--my-color)"
                } / ${s || "50%"})\``
            );
        if (e.length > 0)
            throw new Error(
                `The --alpha(\u2026) function only accepts one argument, e.g.: \`--alpha(${i || "var(--my-color)"
                } / ${s || "50%"})\``
            );
        return Q(i, s);
    }
    ...
    function zi(t) {
        ...
        for (let a of t) {
            ...
            o || ((o = { utility: f, items: [] }), e.set(f, o)),
                f !== o.utility &&
                (r.push(o), (o = { utility: f, items: [] }), e.set(f, o)),
                u ? i.get(f).push(a) : o.items.push(a);
        }
    ...
    function Kr(t, r) {
        let { astNodes: o, nodeSorting: e } = he(Array.from(r), t),
    ...
    var Kt = class {
        ...
        set(r, { kind: o, applyFn: e, compounds: i, compoundsWith: s, order: a }) {
            ...
            f
                ? Object.assign(f, { kind: o, applyFn: e, compounds: i })
                : (a === void 0 &&
            ...
            if (
                (j([c], (g, { path: v }) => {
                    ...
                    let k = [],
                        x = [];
                    for (let $ of v)
                        $.kind === "at-rule" ? k.push($) : $.kind === "rule" && x.push($);
        ...
        o("first", ["&:first-child"]),
            ...
            r.functional("aria", (c, p) => {
                ...
                p.value.kind === "arbitrary"
                    ? (c.nodes = [M(`&[aria-${Lr(p.value.value)}]`, c.nodes)])
                    : (c.nodes = [M(`&[aria-${p.value.value}="true"]`, c.nodes)]);
            }),
            r.suggest("aria", () => [
                "busy",
                "checked",
            ...
            r.functional("nth", (c, p) => {
                if (
                    !p.value ||
                    p.modifier ||
                    (p.value.kind === "named" && !T(p.value.value))
                )
                    return null;
            ...
            o("contrast-less", ["@media (prefers-contrast: less)"]);
        {
            ...
            var u = c;
            {
                            ...
                            case "functional": {
                                ...
                                return (
                                    g.value.kind === "arbitrary"
                                        ? (v = g.value.value)
                                        : g.value.kind === "named" &&
                                        (v = t.resolveValue(g.value.value, ["--breakpoint"])),
                ...
                r.group(
                    ...
                    r.suggest("max", () =>
                        Array.from(p.keys()).filter((g) => g !== null)
                    ),
                    r.group(
                        () => {
            ...
            }
            {
                            ...
                            case "functional": {
                                ...
                                return (
                                    g.value.kind === "arbitrary"
                                        ? (v = g.value.value)
                                        : g.value.kind === "named" &&
                                        (v = t.resolveValue(g.value.value, ["--container"])),
                                    !v || v.includes("var(") ? null : v
                                );
                            }
                            case "static":
                ...
                r.group(
                    ...
                    r.suggest("@", () => Array.from(p.keys()).filter((g) => g !== null));
            }
        }
        return (
    ...
    function Lt(t, r) {
        j(t, (o, { replaceWith: e }) => {
            if (o.kind === "at-rule" && o.name === "@slot") e(r);
                ...
                return Object.assign(o, I([F(o.name, o.params, o.nodes)])), 1;
        });
    }
    function Ir(t) {
        let r = Pr(t),
            ...
            f = {
                ...
                candidatesToCss(u) {
                    ...
                    for (let p of u) {
                        let m = !1,
                            { astNodes: g } = he([p], this, {
                                onInvalidCandidate() {
                                    m = !0;
                                },
                            });
                        (g = be(g, f, 0)),
                            g.length === 0 || m ? c.push(null) : c.push(le(g));
                    }
                    return c;
                },
                getClassOrder(u) {
                ...
                getVariantOrder() {
                    ...
                    for (let g of u)
                        g !== null &&
                            (p !== void 0 && this.variants.compare(p, g) !== 0 && m++,
                                c.set(g, m),
                                (p = g));
                    return c;
                },
    ...
    function he(t, r, { onInvalidCandidate: o } = {}) {
        ...
        return (
            i.sort((f, u) => {
                let c = e.get(f),
                    p = e.get(u);
                if (c.variants - p.variants !== 0n)
                    return Number(c.variants - p.variants);
                let m = 0;
                for (
                    ;
                    m < c.properties.order.length &&
                    m < p.properties.order.length &&
                    c.properties.order[m] === p.properties.order[m];

                )
                    m += 1;
                return (
                    (c.properties.order[m] ?? 1 / 0) - (p.properties.order[m] ?? 1 / 0) ||
                    p.properties.count - c.properties.count ||
                    at(c.candidate, p.candidate)
                );
            }),
                    ...
                    throw (
                        (m.kind === "at-rule" &&
                            ...
                            j(m.nodes, (k) => {
                                ...
                                for (let y of x)
                                    for (let $ of r.parseCandidate(y))
                                        switch ($.kind) {
                                            case "arbitrary":
                                                break;
                                            case "static":
                                            case "functional":
                                                if (v.params.replace(/-\*$/, "") === $.root)
                                                    throw new Error(
...
${le([v])}`))
        ...
        for (let m of u)
            "nodes" in m &&
                j(m.nodes, (g, { replaceWith: v }) => {
                    if (g.kind !== "at-rule" || g.name !== "@apply") return;
                    let k = g.params.split(/(\s+)/g),
                        x = {},
                        y = 0;
                    for (let [$, b] of k.entries())
                        $ % 2 === 0 && (x[b] = y), (y += b.length);
                    {
                        let $ = Object.keys(x),
                            b = he($, r, {
                                    ...
                                    if (D.length > 1) {
                                        ...
                                        if (r.candidatesToCss([_])[0]) {
                                            let H = r.candidatesToCss(
                                                D.map((B) => `${B}:[--tw-variant-check:1]`)
                                            ),
                                                L = D.filter((B, J) => H[J] === null);
                                            if (L.length > 0) {
                                                if (L.length === 1)
                                                    throw new Error(
                                                        `Cannot apply utility class \`${P}\` because the ${L.map(
                                                            (B) => `\`${B}\``
                            ...
                            R = b.astNodes.map((P) => {
                                let D = b.nodeSorting.get(P)?.candidate,
                                    _ = D ? x[D] : void 0;
                                if (((P = structuredClone(P)), !V || !D || _ === void 0))
                                    return (
                                        j([P], (L) => {
                                            L.src = V;
                                        }),
                            ...
                            K = [];
                        for (let P of R)
                            if (P.kind === "rule") for (let D of P.nodes) K.push(D);
                            else K.push(P);
                        v(K);
                    }
                });
                    ...
                    return (
                        a.push(
                            (async () => {
                                if (e > 100)
                                    throw new Error(
                                        `Exceeded maximum recursion depth while resolving \`${p}\` in \`${r}\`)`
                                    );
                                let x = await o(p, r),
                                    y = Ne(x.content, { from: i ? x.path : void 0 });
                                await It(y, x.base, o, e + 1, i),
                                    (k.nodes = Ii(f, [ue({ base: x.base }, y)], m, g, v));
                            })()
                        ),
                        u(k),
                        1
            ...
            Hr(t, [], (o, e) => {
                ...
                if (Array.isArray(o) && o.every((i) => typeof i == "string"))
                    return (
                        e[0] === "fontSize"
                            ? (r.push([e, o[0]]),
                                o.length >= 2 && r.push([[...e, "-line-height"], o[1]]))
                            : r.push([e, o.join(", ")]),
                        1
                    );
            }),
    ...
    function Hr(t, r = [], o) {
        for (let e of Reflect.ownKeys(t)) {
            ...
            if (a !== 1) {
                if (a === 2) return 2;
                if (!(!Array.isArray(i) && typeof i != "object") && Hr(i, s, o) === 2)
                    return 2;
            }
        }
    }
        ...
        return function (i, s) {
            ...
            let u = (() => {
                ...
                if (
                    ...
                    return typeof m != "object" && m & 4 ? g ?? p : p;
                if (g !== null && typeof g == "object" && !Array.isArray(g)) {
                    ...
                    for (let k in p)
                        k !== "__CSS_VALUES__" &&
                            ((g?.__CSS_VALUES__?.[k] & 4 && Gr(v, k.split("-")) !== void 0) ||
                                (v[ve(k)] = p[k]));
                    return v;
                }
    ...
    function qi(t, r) {
        ...
        for (let [p, m] of s) {
            ...
            (k = k.replace(/-([a-z])/g, (x, y) => y.toUpperCase())),
                i.get(v === "" ? null : v).set(k, [m, t.getOptions(`--${o}${p}`)]);
        }
...
`
    ...
    function Ft({
        ...
        let s = {
                ...
                if (typeof f == "string") {
                    ...
                    let c = function (p, m) {
                        return Object.entries(p).some(
                            ([g, v]) => g.includes(m) || (typeof v == "object" && c(v, m))
                        );
                    };
                    var u = c;
                    if (c(f, ":merge(")) return;
            ...
            matchVariant(a, f, u) {
                function c(m, g, v) {
                    let k = f(m, { modifier: g?.value ?? null });
                    return so(k, v);
                }
                try {
                ...
                t.variants.group(
                    () => {
                        t.variants.functional(a, (m, g) => {
                            ...
                            if (g.value.kind === "arbitrary")
                                m.nodes = c(g.value.value, g.modifier, m.nodes);
                    ...
                    (m, g) => {
                        ...
                        if (u && typeof u.sort == "function")
                            return u.sort(
                                { value: x, modifier: m.modifier?.value ?? null },
                                { value: y, modifier: g.modifier?.value ?? null }
                            );
                        let $ = p.indexOf(v),
                            b = p.indexOf(k);
                        return (
            ...
            matchUtilities(a, f) {
                ...
                for (let [p, m] of Object.entries(a)) {
                    ...
                    f?.supportsNegativeValues &&
                        t.utilities.functional(`-${p}`, g({ negative: !0 }), { types: u }),
                        t.utilities.functional(p, g({ negative: !1 }), { types: u }),
    ...
    var ae = Ce((t) => {
        ...
        mo = {
            ...
            aspectRatio: { auto: "auto", square: "1 / 1", video: "16 / 9", ...ln },
            backdropBlur: ({ theme: t }) => t("blur"),
            backdropBrightness: ({ theme: t }) => ({ ...t("brightness"), ...oe }),
            backdropContrast: ({ theme: t }) => ({ ...t("contrast"), ...oe }),
            backdropGrayscale: ({ theme: t }) => ({ ...t("grayscale"), ...oe }),
            backdropHueRotate: ({ theme: t }) => ({ ...t("hueRotate"), ...mt }),
            backdropInvert: ({ theme: t }) => ({ ...t("invert"), ...oe }),
            backdropOpacity: ({ theme: t }) => ({ ...t("opacity"), ...oe }),
            backdropSaturate: ({ theme: t }) => ({ ...t("saturate"), ...oe }),
            backdropSepia: ({ theme: t }) => ({ ...t("sepia"), ...oe }),
    ...
    function un(t) {
        let r = new Set(),
            ...
            e = Object.assign(o, { theme: o, colors: pt });
        function i(s) {
    ...
    function bo(t, r) {
            ...
            r.variants.functional(
                ...
                (u, c) => {
                    ...
                    return p && p.kind === "named" && p.value in o
                        ? a?.(u, { ...c, value: { kind: "arbitrary", value: o[p.value] } })
                        : a?.(u, c);
                },
                { compounds: f }
            );
            ...
            r.variants.functional(
                ...
                (u, c) => {
                    ...
                    return p && p.kind === "named" && p.value in e
                        ? a?.(u, { ...c, value: { kind: "arbitrary", value: e[p.value] } })
                        : a?.(u, c);
                },
                { compounds: f }
            );
        ...
        if (Object.keys(i).length > 0) {
            ...
            r.variants.functional(
                ...
                (u, c) => {
                    let p = c.value;
                    return p && p.kind === "named" && p.value in i
                        ? a?.(u, { ...c, value: { kind: "arbitrary", value: i[p.value] } })
                        : a?.(u, c);
                },
                { compounds: f }
            );
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`);
        ...
        if (
            ((t.resolveThemeValue = function (g, v) {
                return g.startsWith("--")
                    ? u(g, v)
                    : ((s |= yo({
                        designSystem: t,
    ...
    function yo({
        ...
        let a = 0,
            ...
            { resolvedConfig: c } = Bt(t, [
                { config: go(t.theme), base: r, reference: !0 },
                ...u,
                { config: { plugins: [ko] }, base: r, reference: !0 },
            ]),
            { resolvedConfig: p, replacedThemeKeys: m } = Bt(t, u),
        ...
        let v = {
            ...
            k = Ft({ ...v, referenceMode: !1 }),
            x;
        for (let { handler: y, reference: $ } of c.plugins)
            $ ? ((x ||= Ft({ ...v, referenceMode: !0 })), y(x)) : y(k);
        if (
            (qr(t, p, m),
                co(t, p, m),
                bo(p, t),
        ...
        if (
            ...
            j(o, ($, { replaceWith: b, parent: V }) => {
                if (
                    $.kind === "at-rule" &&
                    !($.name !== "@tailwind" || $.params !== "utilities")
                )
                    return V?.kind === "rule" && V.selector === y ? 2 : (b(M(y, [$])), 2);
            });
        }
...
This feature is not currently supported.`);
            let $ = !1;
            y.pattern[0] == "!" && (($ = !0), (y.pattern = y.pattern.slice(1))),
                e.push({ ...y, negated: $ });
        }
        return a;
    }
    ...
    function Co({ ast: t }) {
        let r = new W((i) => Ao(i.code)),
            o = new W((i) => ({ url: i.file, content: i.code, ignore: !1 })),
...
`)) {
        ...
        return (
            e.mappings.sort(
                (i, s) =>
                    i.generatedPosition.line - s.generatedPosition.line ||
                    i.generatedPosition.column - s.generatedPosition.column ||
                    (i.originalPosition?.line ?? 0) - (s.originalPosition?.line ?? 0) ||
                    (i.originalPosition?.column ?? 0) - (s.originalPosition?.column ?? 0)
            ),
            e
        );
    }
    ...
    async function wn(
        t,
        { base: r = "", from: o, loadModule: e = hn, loadStylesheet: i = kn } = {}
    ) {
        let s = 0;
            ...
            if (b.kind === "at-rule") {
                ...
                if (
                    ...
                    if (b.nodes.length === 0) {
                        ...
                        let H = [],
                            L = [];
                        for (let B of _)
                            (B = B.trim()), B[0] === "@" ? H.push(B) : L.push(B);
                        u.push((B) => {
                            B.variants.static(
                                P,
                                (J) => {
                ...
                if (b.name === "@media") {
                    ...
                    for (let _ of P)
                        if (_.startsWith("source(")) {
                            ...
                            let H = _.slice(7, -1);
                            j(b.nodes, (L) => {
                                if (L.kind === "at-rule" && L.name === "@theme")
                                    return (L.params += ` prefix(${H})`), 1;
                            });
                        } else
                            _ === "important"
                                ? (a = !0)
                ...
                if (b.name === "@theme") {
                    ...
                    if ((K.reference && (P |= 2), D)) {
                        if (!gn.test(D))
                            throw new Error(
                                `The prefix "${D}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`
                            );
                        f.prefix = D;
                    }
                    return (
...
${H}`);
                        ...
                        p ? R([]) : ((p = M(":root, :host", [])), (p.src = b.src), R([p])),
                        1
                    );
                }
            }
    ...
    async function bn(t, r = {}) {
        ...
        e.unshift(
            Ze(`! tailwindcss v${Gt} | MIT License | https://tailwindcss.com `)
        );
        function c(k) {
        ...
        return {
            ...
            build(k) {
                ...
                return (
                    ...
                    !y && g === b.length
                        ? ((m ??= be(e, o, r.polyfills)), m)
                        : ((g = b.length), (a.nodes = b), (m = be(e, o, r.polyfills)), m)
                );
            },
        };
    }
    async function So(t, r = {}) {
        let o = Ne(t, { from: r.from }),
            e = await bn(o, r),
            i = o,
            s = t;
        return {
...
`);
        if (
            (r.includes("@import") || (r = `@import "tailwindcss";${r}`),
                re.end("Reading Stylesheets", { size: r.length, changed: Wt !== r }),
                Wt !== r)
        ) {
    ...
    async function Rn(t) {
        ...
        re.end("Collect classes", { count: r.size }),
            ...
            (re.start("Build utilities"),
                (Ht.textContent = kt.build(Array.from(r))),
