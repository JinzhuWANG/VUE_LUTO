 ...
 */
 ...
 - ${i}: ${e}`,
        ...
        t6.allowedAttributes = ["alt", "aria-controls", "aria-describedby", "aria-expanded", "aria-haspopup", "aria-hidden", "aria-label", "aria-labelledby", "aria-live", "aria-pressed", "aria-readonly", "aria-roledescription", "aria-selected", "class", "clip-path", "color", "colspan", "cx", "cy", "d", "disabled", "dx", "dy", "fill", "filterUnits", "flood-color", "flood-opacity", "height", "href", "id", "in", "in2", "markerHeight", "markerWidth", "offset", "opacity", "operator", "orient", "padding", "paddingLeft", "paddingRight", "patternUnits", "r", "radius", "refX", "refY", "result", "role", "rowspan", "scope", "slope", "src", "startOffset", "stdDeviation", "stroke-linecap", "stroke-width", "stroke", "style", "summary", "tabindex", "tableValues", "target", "text-align", "text-anchor", "textAnchor", "textLength", "title", "type", "valign", "width", "x", "x1", "x2", "xlink:href", "y", "y1", "y2", "zIndex"],
            ...
            t6.allowedTags = ["#text", "a", "abbr", "b", "br", "button", "caption", "circle", "clipPath", "code", "dd", "defs", "div", "dl", "dt", "em", "feComponentTransfer", "feComposite", "feDropShadow", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feMerge", "feMergeNode", "feMorphology", "feOffset", "filter", "h1", "h2", "h3", "h4", "h5", "h6", "hr", "i", "img", "li", "linearGradient", "marker", "ol", "p", "path", "pattern", "pre", "rect", "small", "span", "stop", "strong", "style", "sub", "sup", "svg", "table", "tbody", "td", "text", "textPath", "th", "thead", "title", "tr", "tspan", "u", "ul"],
            t6.emptyHTML = t5,
        ...
        let { defaultOptions: t9, defaultTime: t4 } = tv
            ...
            , el = t => /^["'].+["']$/.test(t);
        function ed(t = "", e, i) {
            let s = /\{([a-zA-Z\u00C0-\u017F\d:\.,;\-\/<>\[\]%_@+"'’= #\(\)]+)\}/g, o = /\(([a-zA-Z\u00C0-\u017F\d:\.,;\-\/<>\[\]%_@+"'= ]+)\)/g, r = [], a = /f$/, n = /\.(\d)/, h = i?.options?.lang || t9.lang, l = i?.time || t4, d = i?.numberFormatter || ec.bind(i), c = (t = "") => {
                let i;
        ...
        class iU {
            constructor(t, e, i, s, o, r, a) {
                ...
                a || l.css(this.getStyle(s || {})),
                    ...
                    this.createElement("desc").add().element.appendChild(iv.createTextNode("Created with Highcharts 12.3.0")),
            ...
            , sf = class {
                ...
                addLabel() {
                    ...
                    r && sc(y) && (y = sr(r.lin2log(y))),
                        e.dateTime && (g ? f = (m = s.time.resolveDTLFormat(i.dateTimeLabelFormats[!i.grid?.enabled && g.higherRanks[n] || g.unitName])).main : sc(y) && (f = e.dateTime.getXDateFormat(y, i.dateTimeLabelFormats || {}))),
                        t.isFirst = d,
                        t.isLast = c;
                    let b = {
                        axis: e,
        ...
        class oO {
            ...
            getAnchor(t, e) {
                ...
                return ob(this, "getAnchor", h),
                    h.ret.map(Math.round)
            }
            getClassName(t, e, i) {
                let s = this.options
                    , o = t.series
        ...
        class oq {
            ...
            getNestedProperty(t) {
                if (t)
                    return 0 === t.indexOf("custom.") ? oF(t, this.options) : this[t]
            }
            getZone() {
        ...
        class rr {
            ...
            drag(t) {
                ...
                if ((!m || !m.touch) && (g < n ? g = n : g > n + l && (g = n + l),
                    ...
                    this.hasZoom && f && !p && !m && (this.selectionMarker = m = e.renderer[r](),
                        m.attr({
            ...
            onContainerMouseMove(t) {
                ...
                this.setHoverChartIndex(t),
                    ...
                    !e.exporting?.openMenu && (this.inClass(s.target, "highcharts-tracker") || e.isInsidePlot(s.chartX - e.plotLeft, s.chartY - e.plotTop, {
                        visiblePlotOnly: !0
            ...
            touch(t, e) {
                ...
                this.setHoverChartIndex(),
                    1 === (t = this.normalize(t)).touches.length ? s.isInsidePlot(t.chartX - s.plotLeft, t.chartY - s.plotTop, {
                        visiblePlotOnly: !0
                    }) && !s.exporting?.openMenu ? (e && this.runPointActions(t),
        ...
        class a0 {
            ...
            reflow(t) {
                ...
                delete e.pointer?.chartPosition,
                    !e.exporting?.isPrinting && !e.isResizing && i && s.width && ((s.width !== i.width || s.height !== i.height) && (V.clearTimeout(e.reflowTimeout),
            ...
            render() {
                ...
                this.drawChartBox(),
                    ...
                    this.dataLabelsGroup || (this.dataLabelsGroup = i.g("datalabels-group").attr({
                        zIndex: 6
                    }).add()),
                    this.renderSeries(),
                    this.addCredits(),
            ...
            transform(t) {
                let { axes: e = this.axes, event: i, from: s = {}, reset: o, selection: r, to: a = {}, trigger: n } = t
                    , { inverted: h, time: l } = this;
                this.hoverPoints?.forEach(t => t.setState()),
                    aW(this, "transform", t);
                let d = t.hasZoomed || !1, c, p;
                for (let t of e) {
                    ...
                    if (r && r[t.coll].push({
                        ...
                        for (let e of t.series) {
                            ...
                            O ?? (O = {
                                ...
                                aG(t.dataMin) && aG(t.dataMax) && (O.dataMin = Math.min(t.dataMin, O.dataMin),
                    ...
                    (!t.isOrdinal || 1 !== k || o) && (P < Y && (P = Y,
                        k >= 1 && (L = P + H)),
                        L > U && (L = U,
                            k >= 1 && (P = L - H)),
                        (o || t.series.length && (P !== D || L !== B) && P >= Y && L <= U) && (r ? r[t.coll].push({
                            axis: t,
                            min: P,
                            max: L
                        }) : (t.isPanning = "zoom" !== n,
        ...
        class ni {
            ...
            moveFixedElements() {
                ...
                if (s && !i ? t = ".highcharts-yaxis" : s && i || o && !i ? t = ".highcharts-xaxis" : o && i && (t = ".highcharts-yaxis"),
                            ...
                            hu(n(c, t.dlOptions || t.options?.dataLabels)).forEach((n, l) => {
                                ...
                                c && (x = ho(m = hp(n[t.formatPrefix + "Format"], n.format)) ? hs(m, t, s) : (n[t.formatPrefix + "Formatter"] || n.formatter).call(t, n),
                                    ...
                                    !v || c && ho(x) && !!(v.div || v.text?.foreignObject) == !!n.useHTML && (v.rotation && n.rotation || v.rotation === n.rotation) || (v = void 0,
                                        k = !0),
                                    c && ho(x) && "" !== x && (v ? b.text = x : (v = r.label(x, 0, 0, n.shape, void 0, void 0, n.useHTML, void 0, "data-label")).addClass(" highcharts-data-label-color-" + t.colorIndex + " " + (n.className || "") + (n.useHTML ? " highcharts-tracker" : "")),
                                        v && (v.options = n,
                                            v.attr(b),
